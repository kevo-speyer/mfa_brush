...
#define ASYM_WALLS 2  /* 1: asymmetric walls with different 9-3 potentials. 2: adiabatic top wall and 9-3 bot wall   */
...
#define THERMOSTAT 2 /*  1=LGV 0=DPD 2=thermal walls       */
