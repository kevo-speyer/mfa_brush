...
subroutine neigh_list(r0, n_part, n_dim, n_cells, n_cells_tot, boundary, inv_l_cell, part_in_cell, r_nei, l_nei)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
integer, intent(in) :: n_part, n_dim,n_cells(n_dim), n_cells_tot
integer, intent(out) :: part_in_cell(0:n_cells_tot), r_nei(n_part), l_nei(n_part)
...
subroutine update_part_cell(r0_part, i_part, n_dim, n_cells, n_cells_tot, inv_l_cell, old_cell, n_part, part_in_cell, r_nei, l_nei)
...
integer, intent(inout) :: part_in_cell(0:n_cells_tot), r_nei(n_part), l_nei(n_part)
...
if( new_cell .ne. old_cell ) then !Update cell list
    !print*,"Cell Change. Old:",old_cell,",New :",new_cell
