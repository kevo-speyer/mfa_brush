...
#       elif BIN_TYPE ==2
          ...
          allocate(part_in_cell(0:n_cells_tot),cell_neigh_ls(n_cells_tot, n_nei_cells) )

          call neigh_list(r0, n_mon_tot, n_dim,n_cells, n_cells_tot, boundary, inv_l_cell, part_in_cell, r_nei, l_nei)
