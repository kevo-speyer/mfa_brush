...
#elif BIN_TYPE == 2
      integer :: n_cells_tot, i_cell, j_cell, j_dummy, n_nei_cells
      integer, allocatable :: part_in_cell(:), r_nei(:), l_nei(:),n_cells(:), cell_neigh_ls(:,:)
      real(kind=8), allocatable :: l_cell(:), inv_l_cell(:)
      integer :: n_buff , n_is, i_dmm, n_left, j_dmm, k_cell
